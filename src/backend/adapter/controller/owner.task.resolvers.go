...
func (r *mutationResolver) UpdateTaskByOwner(ctx context.Context, input OwnerTaskInput) (*OwnerTask, error) {
...
func (r *mutationResolver) DeleteTaskByOwner(ctx context.Context, input OwnerTaskInput) (*string, error) {
...
func (r *queryResolver) ListTaskByOwner(ctx context.Context) ([]*OwnerTask, error) {
...
func (r *queryResolver) FindTaskByOwner(ctx context.Context, filter *OwnerTaskFilter) ([]*OwnerTask, error) {
...
func (r *queryResolver) GetTaskByOwner(ctx context.Context, id string) (*OwnerTask, error) {
